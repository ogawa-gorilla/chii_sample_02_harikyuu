...
export const TREATMENT_RECORD_TESTDATA: TreatmentRecord[] = [
    {
        ...
        staffId: '1',
        date: '2025-06-01',
        time: RESERVATION_TESTDATA.find((r) => r.id === 'tr-1')!.time,
    ...
    },
    {
        ...
        staffId: '2',
        date: '2025-06-04',
        time: RESERVATION_TESTDATA.find((r) => r.id === 'tr-2')!.time,
    ...
    },
    {
        ...
        staffId: '2',
        date: '2025-05-30',
        time: RESERVATION_TESTDATA.find((r) => r.id === 'tr-4')!.time,
    ...
    },
    {
        ...
        staffId: '1',
        date: '2025-05-29',
        time: RESERVATION_TESTDATA.find((r) => r.id === 'tr-5')!.time,
    ...
    },
    {
        ...
        staffId: '3',
        date: '2025-05-29',
        time: RESERVATION_TESTDATA.find((r) => r.id === 'tr-6')!.time,
    ...
    },
    {
        ...
        staffId: '2',
        date: '2025-06-01',
        time: RESERVATION_TESTDATA.find((r) => r.id === 'tr-7')!.time,
        content: '肩関節の可動域改善。',
        attached_images: [],
